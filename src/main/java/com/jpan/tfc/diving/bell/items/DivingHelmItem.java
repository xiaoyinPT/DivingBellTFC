...
public class DivingHelmItem extends ArmorItem{

	public String texturePath;
	
	public DivingHelmItem(String texturePath, ArmorMaterial p_40386_, Type p_266831_, Properties p_40388_) {
            ...
            public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
                HumanoidModel armorModel = new HumanoidModel<LivingEntity>(
                		new ModelPart(
                				...
                				Map.of("hat",
                						new DivingHelmetModel(Minecraft.getInstance().getEntityModels().bakeLayer(DivingHelmetModel.LAYER_LOCATION)).head,
